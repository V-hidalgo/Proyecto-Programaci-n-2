...
def get_default_menus() -> List[IMenu]:
    return [
        CrearMenu(
            ...
            precio=1800,
            icono_path="ev2_progra2.1/IMG/icono_hotdog_sin_texto_64x64.png",
        ),
        ...
        CrearMenu(
                ...
                precio=500,
                icono_path="ev2_progra2.1/IMG/icono_papas_fritas_64x64.png"
        ),
        CrearMenu(
                nombre="Pepsi",
                ingredientes=[Ingrediente("Pepsi", "unid", 1)],
                precio=1100,
                icono_path="ev2_progra2.1/IMG/icono_cola_64x64.png"
        ),
        CrearMenu(
                nombre="Coca-Cola",
                ingredientes=[Ingrediente("Coca cola", "unid", 1)],
                precio=1100,
                icono_path="ev2_progra2.1/IMG/icono_cola_lata_64x64.png"
        ),
        CrearMenu(
                nombre="Hamburguesa",
                ingredientes=[
                ...
                precio=3500,
                icono_path="ev2_progra2.1/IMG/icono_hamburguesa_negra_64x64.png"
        ),
        CrearMenu(
                nombre="Panqueques",
        ...
        CrearMenu(
                ...
                precio=1000,
                icono_path="ev2_progra2.1/IMG/icono_empanada_queso_64x64.png"
        ),
        CrearMenu(
                nombre="Chorrillana",
                ingredientes=[
                ...
                precio=3000,
                icono_path="ev2_progra2.1/IMG/icono_chorrillana_64x64.png"
        ),
        CrearMenu(
                ...
                precio=2000,
                icono_path="ev2_progra2.1/IMG/icono_panqueques_con_manjar_64x64.jpeg"
        ),
        CrearMenu(
                nombre="Pollo Frito",
                ingredientes=[
                ...
                precio=2800,
                icono_path="ev2_progra2.1/IMG/icono_pollo_frito_64x64.png"
        )
